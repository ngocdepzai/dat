 ...
 */
public class InternalCameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public InternalCameraPreview(Context context) {
        super(context);
        init();
    }

    public InternalCameraPreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public InternalCameraPreview(Context context, AttributeSet attrs, int defStyleAttr) {
